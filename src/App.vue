    ...
    <v-app>
        ...
        <v-footer color="secondary">
            <v-row class="d-flex flex-row align-center justify-center text-center ma-0">
                <v-col class="pa-0">
                    <a href="https://www.instagram.com/secmun2024?igsh=MW1qbWt4bW9qZ2k3bg==" target="_blank"
                        rel="noopener" class="text-white">
        ...
        <v-dialog width="auto" v-model="subscribe" close-on-back>
            <v-card color="primary">
                ...
                <v-card-title class="text-center text-wrap text-subtitle-2 literaturnaya mx-6">
